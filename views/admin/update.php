...
<div class="container-fluid ls-space padding left-50 right-50 ">
    <div class="row">
        <div class="col-xs-12 h1 pagetitle">
            <?php echo gT("Update notification").' - '.$model->id;?>
        </div>
        <div class="col-xs-12">
    ...
    <div class="row">
        <div class="col-xs-12 col-md-8" style="float:none; margin:0 auto;">
            ...
            <?= TbHtml::formTb(null, App()->createUrl('admin/pluginhelper/sa/fullpagewrapper/plugin/LimeAdminNotifications/method/update',["id"=>$model->id]), 'post', []) ?>
            ...
            <div class="row ls-space margin bottom-5 top-5">
                ...
                <div class="row ls-space margin bottom-5 top-5">
                    <?php echo CHtml::submitButton(gT('Save'), array('name' => 'publish', 'class' => 'btn btn-primary')); ?>
                </div>
                </form>
            </div>
        </div>
